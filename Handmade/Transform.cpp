...
const glm::mat4& Transform::GetMatrix()
{
	if (m_isDirty)
	{
		...
		m_transform = glm::rotate(m_transform, Utility::DegToRad(m_euler.x), glm::vec3(1.0f, 0.0f, 0.0f));
		m_transform = glm::rotate(m_transform, Utility::DegToRad(m_euler.y), glm::vec3(0.0f, 1.0f, 0.0f));
		m_transform = glm::rotate(m_transform, Utility::DegToRad(m_euler.z), glm::vec3(0.0f, 0.0f, 1.0f));
